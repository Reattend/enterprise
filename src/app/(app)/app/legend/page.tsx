...
import {
  ...
  ScrollText, Activity, Building2, Plug, Settings, Shield, Search, Command,
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        desc: 'Org-wide control panel. Members, departments, decisions, policies, agents, integrations, self-healing, audit, settings — all one click from the top-left org pill.',
        icon: Activity,
        who: ['super_admin', 'admin'],
        status: 'live',
      },
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        desc: 'For paper-heavy orgs: scan → text extraction → memory, at accuracy good enough for legal + compliance workflows.',
        icon: FileText,
        status: 'soon',
        who: ['super_admin', 'admin', 'member'],
      },
      {
        title: 'Meeting Prep panel',
        desc: '15 minutes before a calendar event: "Here\'s the last decision on this topic, 3 relevant past memories, the open question from last time, who\'s attending + their recent context."',
        icon: Clock,
        status: 'soon',
        who: ['super_admin', 'admin', 'member'],
      },
      {
        ...
        desc: 'Agents that draft Jira tickets, send Slack messages, schedule follow-ups. Read-only Q&A is today; action is next.',
        icon: Bot,
        status: 'soon',
        who: ['super_admin', 'admin', 'member'],
      },
